  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        magical: "hsl(var(--magical-glow))",
        parchment: "hsl(var(--parchment))",
        bronze: "hsl(var(--bronze))",
        mythril: "hsl(var(--mythril))",
        sidebar: {
      ...
      backgroundImage: {
        'magical-gradient': 'var(--gradient-magical)',
      ...
      keyframes: {
        ...
        "glow": {
          "0%, 100%": { filter: "drop-shadow(0 0 5px hsl(var(--magical-glow) / 0.5))" },
          "50%": { filter: "drop-shadow(0 0 20px hsl(var(--magical-glow) / 0.8))" },
        },
        "float": {
